...
cmd({
            pattern: "tgs",
            desc: "විදුලි පණිවුඩ ස්ටිකර් බාගත කරයි.",
            category: "downloader",
            filename: __filename,
            use: '<add sticker url.>',
        },
...
cmd({
            pattern: "pint",
            desc: "Pinterest වෙතින් රූපය බාගත කරයි.",
            category: "downloader",
            filename: __filename,
            use: '<text|image name>',
        },
...
cmd({
            ...
            desc: "Mediafire වෙතින් zip බාගැනීම්..",
            category: "downloader",
            react: "⬇️",
            filename: __filename,
...
cmd({
            pattern: "yts",
            alias: ["සොයන්න","yt"],
            desc: "youtube වෙතින් විමසුම් විස්තරාත්මක තොරතුරු ලබා දෙයි..",
            category: "downloader",
            filename: __filename,
            use: '<yt search text>',
        },
...
cmd({
        pattern: "song",
        desc: "yt සබැඳිය මඟින් ශ්‍රව්‍ය බාගත කරයි.",
        category: "downloader",
        react: "🎶",
        use: '<yt video url>',
    },
        ...
        try {
            ...
            citel.react("✅");
                let buttonMessage = {
                        ...
                        caption: `Qᴜᴇᴇɴ-ɴᴇᴛʜᴜ-ᴍᴅ ⦁ ᴍᴀᴅᴇ ʙʏ ᴍʀ.ʜᴀɴꜱᴀᴍᴀʟᴀ\ꜱɪɴʜᴀʟᴀ ʙᴏᴛ ⦁ `,
                        headerType: 4,
                    }
        ...
        try {
            ...
            citel.react("✅");
                ...
                let buttonMessage = {
                        ...
                        caption: `Qᴜᴇᴇɴ-ɴᴇᴛʜᴜ-ᴍᴅ ⦁ ᴍᴀᴅᴇ ʙʏ ᴍʀ.ʜᴀɴꜱᴀᴍᴀᴀ\ꜱɪɴʜᴀʟᴀ ʙᴏᴛ⦁ `,
        ...
        try {
            ...
            citel.react("✅");
                ...
                let buttonMessage = {
                        ...
                        caption: `Qᴜᴇᴇɴ-ɴᴇᴛʜᴜ-ᴍᴅ ⦁ ᴍᴀᴅᴇ ʙʏ ᴘʀᴀʙᴀᴛʜ\ꜱɪɴʜᴀʟᴀ ʙᴏᴛ ⦁ `,
