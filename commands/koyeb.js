...
cmd(
  {
    pattern: "updatenow",
    desc: "නැවුම් කැපවීමකින් බොට් යාවත්කාලීන කරන්න.",
    filename: __filename,
    category: "misc",
  },
...
cmd(
  {
    pattern: "getvar",
    desc: "koyeb වෙතින් අපේක්ෂිත var ලබා ගන්න.",
    filename: __filename,
    category: "misc",
  },
  async (Void,citel,text,{isCreator}) => {
...
cmd(
  {
    pattern: "getallvar",
    desc: "සියලුම vars koyeb වෙතින් ලබා ගන්න.",
    filename: __filename,
    category: "misc",
  },
  async (Void,citel,text,{isCreator}) => {
