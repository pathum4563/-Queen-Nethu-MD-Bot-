...
cmd({
            pattern: "movie",
            category: "search",
            desc: "අසන ලද චිත්‍රපට/මාලාවේ රූපය යවයි.",
            use: '<text>',
            filename: __filename,
        },
...
cmd({
            pattern: "weather",
            category: "search",
            desc: "අසන ලද ස්ථානය පිළිබඳ කාලගුණ තොරතුරු යවයි.",
            use: '<location>',
            filename: __filename,
        },
        async(Void, citel, text) => {
...
cmd({
            pattern: "horo",
            category: "search",
            desc: "පරිශීලකයාගේ කේන්දර තොරතුරු ලබා දෙයි.",
            use: '<sign>\n:Example: horo libra',
            filename: __filename,
        },
        async(Void, citel, text) => {
...
cmd({
            pattern: "google",
            category: "search",
            desc: "Google සෙවුමෙන් ලබා දී ඇති විමසුමක තොරතුරු යවයි.",
            use: '<text>',
            filename: __filename,
        },
        async(Void, citel, text) => {
...
cmd({
            ...
            alias: ["image"],
            category: "search",
            desc: "Google වලින් පින්තූරය සොයයි",
            use: '<text>',
            filename: __filename,
        },
        async(Void, citel, text) => {
